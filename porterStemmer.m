function st = porterStemmer(Stin)
Stin = lower(Stin);
global j;
b = Stin;
ki = length(b);
...
if ki > 2
    xi = step1ab(b, ki, k0);
    xi = step1c(xi{1}, xi{2}, k0);
    xi = step2(xi{1}, xi{2}, k0);
    xi = step3(xi{1}, xi{2}, k0);
    xi = step4(xi{1}, xi{2}, k0);
    xi = step5(xi{1}, xi{2}, k0);
    st = xi{1};
end
function cs = cons(i, b, k0)
cs = true;
switch(b(i))
    case {'a', 'e', 'i', 'o', 'u'}
        cs = false;
